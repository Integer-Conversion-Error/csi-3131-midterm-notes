...
\hypersetup{
    ...
    filecolor=magenta,      
    urlcolor=cyan,
    pdftitle={Operating Systems Notes - Chapter 13},
    pdfpagemode=FullScreen,
}

\title{Operating Systems Notes - Chapter 13}
...
\input{ch13/section13.1.tex}
\newpage
\input{ch13/section13.2.tex}
\newpage
\input{ch13/section13.3.tex}
\newpage
\input{ch13/section13.4.tex}
\newpage
\input{ch13/section13.5.tex}
\newpage
