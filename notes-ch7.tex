...
\hypersetup{
    ...
    filecolor=magenta,      
    urlcolor=cyan,
    pdftitle={Operating Systems Notes Chapter 7},
    pdfpagemode=FullScreen,
}

\title{Operating Systems Notes Chapter 7}
...
\input{ch7/section7.1.tex}

\newpage
\input{ch7/section7.2.tex}

\newpage
\input{ch7/section7.3.tex}

\newpage
\input{ch7/section7.4.tex}

\newpage
\input{ch7/section7.5.tex}
